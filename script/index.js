...
class updateSelectedCityData {
  ...
  async updateFutureHrsTempImgBasedOnInput() {
    ...
    //loop to update each hr time of next 5 hrs using time data.
  }
...
function updateSelectedCityBasedOnInput() {
  ...
  if (isValidCity) {
    ...
    //selectedCityData.updateFutureHrsTempImgBasedOnInput();
...
class updateCityCards extends updateSelectedCityData {
  ...
  continentslist = [];
  selectedWeatherIcon;
  cont = document.getElementById("cards-container");
  constructor() {
   ...
   *
   */
  updateButtonScrollWhenScreenReduce() {
   
    var ele = document.getElementById("cards-container");
    var sw = ele.scrollWidth;
    var cw = ele.clientWidth;

    if (sw > cw) {
     
      updateCardDetails.removeCarousel();
      updateCardDetails.createCarousel();
      document.getElementById('backwardArrow').addEventListener("click", () => { updateCardDetails.cont.scrollLeft -= 600; });
      document.getElementById('forwardArrow').addEventListener("click", () => { updateCardDetails.cont.scrollLeft += 600; });
  ...
  displaySunnyCities() {
    ...
    setInterval(updateCardDetails.updateButtonScrollWhenScreenReduce, 1000);
  }
  ...
  /**
   *create left and right carousel buttons.
   *
   * @memberof updateCityCards
   */
  createCarousel() {
    updateCardDetails.createLeftCarouselButton();
    updateCardDetails.createRightCarouselButton();

  }

  /**
   *create left carousel dynamically.
   *
   * @memberof updateCityCards
   */
  createLeftCarouselButton() {
    var buttonLeft = document.getElementById('backwardArrow');
    var buttonLeftDiv = document.createElement('div');
    buttonLeftDiv.setAttribute("class", "backward-Arrow");
    buttonLeft.appendChild(buttonLeftDiv);
    var buttonLeftImg = document.createElement('img');
    buttonLeftDiv.appendChild(buttonLeftImg);
    buttonLeftImg.src = './assets/backwardArrow.svg';
    buttonLeftImg.setAttribute('class', 'backward-Arrowbutton');
    buttonLeftImg.setAttribute('id', 'backwardArrowbtn');
  }

  /**
   *create right carousel dynamically.
   *
   * @memberof updateCityCards
   */
  createRightCarouselButton() {
    var buttonRight = document.getElementById('forwardArrow');
    var buttonRightDiv = document.createElement('div');;
    buttonRightDiv.setAttribute("class", "forward-Arrow");
    buttonRight.appendChild(buttonRightDiv);
    var buttonRightImg = document.createElement('img');
    buttonRightDiv.appendChild(buttonRightImg);
    buttonRightImg.src = './assets/forwardArrow.svg';
    buttonRightImg.setAttribute('class', 'forward-Arrowbutton');
    buttonRightImg.setAttribute('id', 'forwardArrowbtn');
  }
  ...
  /**
   *remove left and right carousel buttons.
   *
   * @memberof updateCityCards
   */
  removeCarousel() {
    var buttonLeftDiv = document.getElementById('backwardArrow');
    var buttonRightDiv = document.getElementById('forwardArrow');
    buttonLeftDiv.replaceChildren();
    buttonRightDiv.replaceChildren();
  }
